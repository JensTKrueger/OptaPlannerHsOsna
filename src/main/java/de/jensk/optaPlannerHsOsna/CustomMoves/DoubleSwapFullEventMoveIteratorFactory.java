 ...
 */
public class DoubleSwapFullEventMoveIteratorFactory
     ...
     * all possible DoubleSwapFullEvents in a random order.
     * @param scoreDirector The current ScoreDirector.
    ...
    public Iterator<? extends Move<CourseSchedule>> createRandomMoveIterator(
        ...
        return new DoubleSwapFullEventMoveIterator(scoreDirector, workingRandom);
    }
