...
/**
 * This factory creates the DoubleChangeFullEventMoveIterator.
 */
public class DoubleChangeFullEventMoveIteratorFactory
    ...
    public long getSize(ScoreDirector<CourseSchedule> scoreDirector) {
        return scoreDirector.getWorkingSolution().getRoomList().size()
                * scoreDirector.getWorkingSolution().getRoomList().size()
     ...
     * all possible DoubleChangeFullEvents in a random order.
     * @param scoreDirector The current ScoreDirector.
    ...
    public Iterator<? extends Move<CourseSchedule>> createRandomMoveIterator(
        ...
        return new DoubleChangeFullEventMoveIterator(scoreDirector, workingRandom);
    }
